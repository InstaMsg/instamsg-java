...
public class InstaMsg {
	...
	public static void initInstaMsg(InstaMsg c, InitialCallbacks callbacks, String platform) {
		...
		modulesProvideInterface = ModulesProviderFactory.getModulesProvider(platform);
		    ...
		    */
			...
			//c->connectOptions.willFlag = 0; // See how to integrate this
		    ...
		    //c.connectOptions.setClientId   // See how to integrate this.
	...
	public static byte[] getEncodedMqttMessageAsByteStream(MqttWireMessage message) {
		byte[] bytes;
		try {
